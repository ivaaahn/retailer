...
async def get_by_shop(product_id: int, shop_id: int) -> ShopProductDTO:
...
async def get_list(
    ...
    return ShopProductsListDTO(
        products=[
            ...
            ShopProductDTO(
                id=6, name="Random Name #2", description="Hello World!", price=100,category="Category1",
            ),
            ShopProductDTO(
                id=7, name="Random Name #2", description="Hello World!", price=100,category="Category2",
            ),
        ],
        total=7,
    )
