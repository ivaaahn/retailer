...
def upgrade():
    ...
    op.create_index(op.f("ix_shops_city"), "shop", ["city"], unique=False)
    op.create_index(op.f("ix_shops_street"), "shop", ["street"], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_shops_street"), table_name="shop")
    op.drop_index(op.f("ix_shops_city"), table_name="shop")
    op.drop_table("shop")
    # ### end Alembic commands ###
